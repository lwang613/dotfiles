...
Global scope only — security boundaries, toolchain defaults, style. **Project-specific rules live in
that project's `AGENTS.md`**: assembly, directory layout, cluster headers, build commands. If a
project rule contradicts this file, nothing arbitrates it — tell me, and I will fix one of them.
